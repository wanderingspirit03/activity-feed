...
function useWebsocket() {
    var isConnected = (0, live_store_1.useLiveStore)(function (state) { return state.isConnected; });
    var addEvent = (0, live_store_1.useLiveStore)(function (state) { return state.addEvent; });
    var setConnected = (0, live_store_1.useLiveStore)(function (state) { return state.setConnected; });
    ...
    var clearReconnectTimer = function () {
