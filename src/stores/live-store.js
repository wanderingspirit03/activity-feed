...
function normalizeActivity(item) {
	...
	var startedAt =
		(_b = (_a = item.startedAt) !== null && _a !== void 0 ? _a : item.timestamp) !== null && _b !== void 0
			? _b
			: Date.now();
	var inferredStatus =
	...
	return {
		id:
			(_c = item.id) !== null && _c !== void 0
				? _c
				: "".concat((_d = item.toolName) !== null && _d !== void 0 ? _d : "event", "-").concat(startedAt),
		type: (_e = item.type) !== null && _e !== void 0 ? _e : "activity",
		title:
			(_h =
				(_g = (_f = item.title) !== null && _f !== void 0 ? _f : item.description) !== null && _g !== void 0
					? _g
					: item.toolName) !== null && _h !== void 0
				? _h
				: "Activity",
		...
		startedAt: startedAt,
		completedAt:
			(_j = item.completedAt) !== null && _j !== void 0 ? _j : inferredStatus === "running" ? undefined : Date.now(),
...
function normalizeRun(run) {
	...
	return {
		...
		tools: ((_e = run.activities) !== null && _e !== void 0 ? _e : []).map((activity) => normalizeActivity(activity)),
		currentPhase: (_f = run.phase) !== null && _f !== void 0 ? _f : "queued",
	};
}
exports.useLiveStore = (0, zustand_1.create)((set) => ({
	runs: new Map(),
	isConnected: false,
	lastEventAt: null,
	addEvent: (event) => {
		...
		set((state) => {
			...
			if (message.type === "runs" && Array.isArray(message.data)) {
				for (var _i = 0, _g = message.data; _i < _g.length; _i++) {
					var run = _g[_i];
					if (!(run === null || run === void 0 ? void 0 : run.runId)) continue;
			...
			if (message.type === "run.update" && ((_a = message.data) === null || _a === void 0 ? void 0 : _a.runId)) {
				...
				nextRuns.set(
					incoming.runId,
					__assign(__assign(__assign({}, existing), incoming), {
						tools:
							incoming.tools.length > 0
								? incoming.tools
								: (_b = existing === null || existing === void 0 ? void 0 : existing.tools) !== null && _b !== void 0
									? _b
									: [],
					}),
				);
			...
			if (message.type === "activity" && ((_c = message.data) === null || _c === void 0 ? void 0 : _c.runId)) {
				...
				var existing =
					(_d = nextRuns.get(runId)) !== null && _d !== void 0
						? _d
						: {
								runId: runId,
								taskPreview: "",
				...
				var idx = tools.findIndex((tool) => tool.id === activity_1.id);
				if (idx >= 0) {
				...
				nextRuns.set(
					runId,
					__assign(__assign({}, existing), {
						status: activity_1.status === "error" ? "error" : existing.status,
						lastAt: activity_1.startedAt,
						currentPhase: (_f = activityRaw.phase) !== null && _f !== void 0 ? _f : existing.currentPhase,
						tools: tools,
					}),
				);
				return { runs: nextRuns, lastEventAt: now };
