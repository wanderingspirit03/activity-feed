		...
		return __generator(this, (_a) => {
			switch (_a.label) {
				...
				case 3:
					...
					return [
						2 /*return*/,
						server_1.NextResponse.json({ error: "Failed to load ops data", detail: String(error_1) }, { status: 500 }),
					];
				case 4:
					return [2 /*return*/];
			}
		...
		return __generator(this, (_a) => {
			switch (_a.label) {
				...
				case 1:
					body = _a.sent();
					description =
						typeof (body === null || body === void 0 ? void 0 : body.description) === "string"
				...
				case 3:
					...
					return [
						...
						server_1.NextResponse.json(
							{ error: error_2 instanceof Error ? error_2.message : "Failed to publish command" },
							{ status: 500 },
						),
					];
				case 4:
