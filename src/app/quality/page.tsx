...
import { AlertTriangle, BarChart3, ChevronDown, ClipboardCheck, Coffee, Gauge, ListChecks } from "lucide-react";
			...
			<section className="grid grid-cols-2 gap-3 lg:grid-cols-3">
				...
				<Card>
					...
					<CardContent className="text-xs text-muted-foreground">
						Number of tasks included in this analysis.
					</CardContent>
				</Card>
			</section>
											...
											<CollapsibleContent>
												<CardContent className="pt-0 pb-5 text-sm space-y-3">
													...
													<div className="grid gap-2 sm:grid-cols-3 text-xs text-muted-foreground">
														...
														<p>
															Duration:{" "}
															{entry.stats?.durationMs ? `${Math.round(entry.stats.durationMs / 1000)}s` : "—"}
														</p>
													</div>
